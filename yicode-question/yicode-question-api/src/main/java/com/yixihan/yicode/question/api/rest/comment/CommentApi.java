...
public interface CommentApi {
    ...
    ApiResult<RootCommentDetailDtoResult> addRootComment(@RequestBody AddRootCommentDtoReq dtoReq);
    
    @ApiOperation("添加子评论")
    @PostMapping(value = "/add/son", produces = "application/json")
    ApiResult<SonCommentDetailDtoResult> addSonComment(@RequestBody AddSonCommentDtoReq dtoReq);
    
    @ApiOperation("删除父评论")
    @PostMapping(value = "/del/root", produces = "application/json")
    void delRootComment(@RequestBody Long rootCommentId);
    
    @ApiOperation("删除子评论")
    @PostMapping(value = "/del/son", produces = "application/json")
    void delSonComment(@RequestBody Long sunCommentId);
    
    @ApiOperation("获取评论数量")
    @PostMapping(value = "/all/count", produces = "application/json")
    ApiResult<Integer> commentCount(@RequestBody QuestionCommentCountDtoReq dtoReq);
    ...
    void likeRootComment(@RequestBody LikeDtoReq dtoReq);
    
    @ApiOperation("点赞子评论")
    @PostMapping(value = "/like/son", produces = "application/json")
    void likeSonComment(@RequestBody LikeDtoReq dtoReq);
    ...
    ApiResult<Boolean> verifyRootComment(@RequestBody Long rootCommentId);
    
    @ApiOperation("校验子评论是否存在")
    @PostMapping(value = "/verify/son", produces = "application/json")
    ApiResult<Boolean> verifySonComment(@RequestBody Long sonCommentId);
