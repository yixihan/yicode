...
public interface LabelNoteApi {
    ...
    ApiResult<CommonDtoResult<Boolean>> addNoteLabel (@RequestBody ModifyLabelNoteDtoReq dtoReq);
    
    @ApiOperation ("删除题解标签")
    @PostMapping(value = "/del", produces = "application/json")
    ApiResult<CommonDtoResult<Boolean>> delNoteLabel (@RequestBody ModifyLabelNoteDtoReq dtoReq);
