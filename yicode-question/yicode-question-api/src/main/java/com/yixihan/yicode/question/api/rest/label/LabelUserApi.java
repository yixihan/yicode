...
public interface LabelUserApi {
    ...
    ApiResult<List<LabelDtoResult>> addUserLabel (@RequestBody ModifyLabelUserDtoReq dtoReq);
    
    @ApiOperation ("删除用户标签")
    @PostMapping(value = "/del", produces = "application/json")
    ApiResult<List<LabelDtoResult>> delUserLabel (@RequestBody ModifyLabelUserDtoReq dtoReq);
